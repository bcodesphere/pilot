...
/**
 * Estado de la empresa; coincide con el CHECK de la columna estado en la base de datos.
 */
export type EstadoEmpresa = typeof EstadoEmpresa[keyof typeof EstadoEmpresa];


export const EstadoEmpresa = {
  ACTIVA: 'ACTIVA',
  INACTIVA: 'INACTIVA',
} as const;
